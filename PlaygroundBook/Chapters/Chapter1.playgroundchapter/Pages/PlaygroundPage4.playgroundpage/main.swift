...
var character:String = /*#-editable-code Type Emoji 'Thumbs Up' Here*/""/*#-end-editable-code*/
//#-hidden-code
import BookCore
...
let viewController = UIHostingController(rootView: getPage4View(s:character))
