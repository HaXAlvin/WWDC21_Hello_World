...
var character:String = /*#-editable-code Type Emoji 'High Five' Here*/""/*#-end-editable-code*/
//#-hidden-code
import BookCore
...
let viewController = UIHostingController(rootView: getPage3View(s:character))
